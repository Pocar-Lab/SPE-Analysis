...
alpha = AlphaData(path = 'C:/Users/Hannah/Documents/Raw Results/Alpha Amplitudes/May2023_Alpha_1us.csv', 
                  path_spe = 'C:/Users/Hannah/DocumentsRaw Results/Breakdown Voltage/May_170K_vbd_bias_20240301.csv',
                  invC_alpha = (invC_alpha,invC_alpha_err),
                  invC_spe = (invC_spe_filter,invC_spe_err_filter),
                  spe_bias_key = ('Bias Voltage [V]', 'Bias Voltage [V] error')
                  )
...
alpha = AlphaData(path = 'D:/Raw Results/Alpha Amplitudes/May2023_Alpha_1us.csv', 
                  path_spe = 'D:/Raw Results/Breakdown Voltage/May_170K_vbd_bias_20240301.csv',
                  invC_alpha = (invC_alpha,invC_alpha_err),
                  invC_spe = (invC_spe_filter,invC_spe_err_filter),
                  spe_bias_key = ('Bias Voltage [V]', 'Bias Voltage [V] error')
                  )
...
alpha = AlphaData(path = 'D:/Raw Results/Alpha Amplitudes/May2023_Alpha_1us.csv', 
                  path_spe = 'C:/Users/Hannah/Downloads/August 1/August1_silicon_vbd.csv',
                  invC_alpha = (invC_alpha,invC_alpha_err),
                  invC_spe = (invC_spe_filter,invC_spe_err_filter),
                  spe_bias_key = ('Bias Voltage [V]', 'Bias Voltage [V] error')
                  )
